...
public class TrainerController {
    ...
    public String updateTrainer(@PathVariable Long trainerId, @ModelAttribute TrainerUpdateRequestDto trainerUpdateRequestDto, RedirectAttributes redirectAttributes) {
        try {
