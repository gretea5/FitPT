...
1. [**서비스 소개 및 기획배경**](#%EF%B8%8F-서비스-소개-및-기획배경)
1. [**기술 스택**](#-기술-스택)
1. [**주요 기능**](#-주요-기능)
1. [**프로젝트 구조**](#-프로젝트-구조)
1. [**영상 포트폴리오**](#-영상-포트폴리오)
...
#### 2️⃣ 회원 관리
<img src="./assets/gif/manager_member.gif" alt="manager_member" width="1000px" />
<br>
...
|                                    Architecture                                    |
| :--------------------------------------------------------------------------------: |
| <img src="./assets/img/fitpt_infra.png" alt="Architecture" width="1000px" /> |
